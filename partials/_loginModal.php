  ...
  <div class="modal-dialog modal-dialog-centered rounded-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background: linear-gradient(to right, #ff9a00, #ff5252);">
        <h5 class="modal-title text-white text-uppercase d-flex justify-content-center w-100" style="font-size: 30px;">
          Login</h5>
      ...
      <div class="modal-body">
        <form action="partials/_handleLogin.php" method="post">
          ...
          <button type="submit" class="btn btn-primary btn-block"
            style="background: linear-gradient(to right, #ff9a00, #ff5252); border: none;">Submit</button>
        </form>
        <p class="mt-3 text-center">Don't have an account? <a href="#" data-dismiss="modal" data-toggle="modal"
